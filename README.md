...
An OpenHost app that plots **every GPS route from your workouts on a single map** —
...
the app under **podman** (so podman must be running) fronted by a mock OpenHost
...
```bash
oh app deploy https://github.com/imbue-openhost/openhost-wanderer \
